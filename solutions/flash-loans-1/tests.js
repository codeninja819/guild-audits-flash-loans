...
describe('Flash Loan Exercise 1', function () {
    ...
    let deployer, user;
    const POOL_BALANCE = ethers.parseEther('1000');
    ...
    it('Flash Loan Tests', async function () {
        ...
        const receiver = await ReceiverFactory.deploy(await pool.getAddress());
        ...
        const greedyReceiver = await GreedyReceiverFactory.deploy(await pool.getAddress());
